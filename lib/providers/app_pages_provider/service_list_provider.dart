...
class ServiceListProvider with ChangeNotifier {
  ...
  onReady(sync){
    ...
    controller =  TabController(length: categoryList[selectedIndex].hasSubCategories != null && categoryList[selectedIndex].hasSubCategories!.isNotEmpty ? categoryList[selectedIndex].hasSubCategories!.length : 0 , vsync: sync);
    notifyListeners();
  }
