                    ...
                    widget: Stack(
                        ...
                        children: [
                          SizedBox(
                              ...
                              child: Image.asset(eGifAssets.success,
                                width: MediaQuery.of(context).size.width,fit: BoxFit.cover,)).paddingSymmetric(vertical: Insets.i8)
                              .decorated(
                          ...
                          AnimatedContainer(
                              ...
                              duration: const Duration(milliseconds: 800),decoration: BoxDecoration(
    ...
    Future.delayed(DurationsDelay.s1).then((value) {
      ...
      Future.delayed(DurationsDelay.s2).then((value) {
        ...
        AnimationController(vsync: sync, duration: const Duration(seconds: 2))
          ..forward();
        offsetAnimation =
            Tween<Offset>(begin: const Offset(0, 0.5), end: const Offset(0, 1.7))
                .animate(
                              ...
                              children: [
                                ...
                                if(offsetAnimation != null)
                                  SlideTransition(
                                      ...
                                      child: (offsetAnimation != null && isAnimateOver == true )? Image.asset(eImageAssets.dustbinCover,
                                          height: 38) : const SizedBox() )
                              ]
                          ),
                          // Sub text
