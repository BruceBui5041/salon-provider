...
class WalletDropDown extends StatelessWidget {
  ...
  const WalletDropDown({super.key, this.icon, this.val, this.categoryList, this.onChanged, this.isIcon, this.isServiceManList = false});
    ...
    return DropdownButtonHideUnderline(
        child: ButtonTheme(
            child: DropdownButtonFormField(
                selectedItemBuilder: (context) => categoryList!.asMap().entries.map((e) {
