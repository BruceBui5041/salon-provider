...
class EmptyLayout extends StatelessWidget {
  ...
  final bool isInk,isButton;
  const EmptyLayout({super.key,this.subtitle,this.bTap,this.title,this.buttonText,this.widget,this.inkText,this.inkOnTap,this.isInk = false,this.isButton = false});
