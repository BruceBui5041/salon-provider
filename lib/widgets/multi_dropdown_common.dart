...
class MultiSelectDropDownCustom<T> extends StatefulWidget {
  ...
  @override
  State<MultiSelectDropDownCustom<T>> createState() => _MultiSelectDropDownCustomState<T>();
}

class _MultiSelectDropDownCustomState<T> extends State<MultiSelectDropDownCustom<T>> {
