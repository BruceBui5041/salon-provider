...
class _LocationApi implements LocationApi {
  ...
  Future<BaseResponse<List<Address>>> reverseGeocode(
    ...
    final _options = _setStreamType<BaseResponse<List<Address>>>(
    ...
    late BaseResponse<List<Address>> _value;
    try {
      _value = BaseResponse<List<Address>>.fromJson(
        _result.data!,
  ...
  Future<BaseResponse<Address>> geocodePlaceDetail(
    GeocodePlaceDetailReq requestBody,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(requestBody.toJson());
    final _options = _setStreamType<BaseResponse<Address>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseResponse<Address> _value;
    try {
      _value = BaseResponse<Address>.fromJson(
        _result.data!,
