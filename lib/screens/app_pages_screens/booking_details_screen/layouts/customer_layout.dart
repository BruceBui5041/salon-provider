        ...
        child: Column(
          ...
          Text(language(context, title!),
              style: appCss.dmDenseMedium12
                  .textColor(appColor(context).appTheme.lightText)).padding(horizontal: Insets.i15,top: Insets.i15),
          ...
          Row( children: [
            ...
            Column(
              children: [
                ...
                ContactDetailRowCommon(
                    image: eSvgAssets.phone, title: data.phone)
                    .paddingSymmetric(vertical: Insets.i15),
                ContactDetailRowCommon(
                ...
                .boxShapeExtension(color: appColor(context).appTheme.whiteBg).padding(horizontal: Insets.i15,bottom:  Insets.i15)
