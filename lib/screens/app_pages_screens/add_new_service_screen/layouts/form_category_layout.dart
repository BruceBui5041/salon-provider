    ...
    return Column(
      children: [
          ...
          Container(
              ...
              child: Row(
                  ...
                  children: [
                   Row(
                     children: [
                       SvgPicture.asset(eSvgAssets.commission,colorFilter: ColorFilter.mode(appColor(context).appTheme.lightText, BlendMode.srcIn)),
        ...
        TextFieldCommon(
            ...
            prefixIcon: eSvgAssets.locationOut).inkWell( onTap: ()=> value.onAvailableServiceTap(context))
            .paddingSymmetric(horizontal: Insets.i20),
        ContainerWithTextLayout(
            title:
            language(context, appFonts.minRequiredServiceman))
            .paddingOnly(top: Insets.i24, bottom: Insets.i12),
        TextFieldCommon(
          keyboardType: TextInputType.number,
