...
class SelectServicemenLayout extends StatelessWidget {
  ...
  final dynamic data;
  final String? amount;
  const SelectServicemenLayout({super.key,this.onTap, this.index, this.list, this.data, this.selectIndex, this.amount});
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      RichText(text: TextSpan(
                        ...
                        style: appCss.dmDenseMedium12.textColor(appColor(context).appTheme.green),
                        children: [
                          TextSpan(
                            text: "\$${amount ?? "0"}",
                            style: appCss.dmDenseSemiBold14.textColor(appColor(context).appTheme.green)
                          ),
                          TextSpan(
