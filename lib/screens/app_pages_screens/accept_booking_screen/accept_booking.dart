...
class AcceptBookingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer2<AcceptedBookingProvider,AssignBookingProvider>(builder: (context, value,assignValue, child) {
                ...
                children: [
                  SingleChildScrollView(
                      child: Column(
                          ...
                          children: [
                        StatusDetailLayout(onMore: ()=> route.pushNamed(context, routeName.servicemanDetail, arg: false),
                  ...
                  Material(
                    elevation: 20,
                    child: isFreelancer ? BottomSheetButtonCommon(textOne: appFonts.cancelService,textTwo: appFonts.startService,clearTap: ()=> assignValue.onCancel(context),applyTap: ()=> assignValue.onStartServicePass(context)).paddingAll(Insets.i20) : ButtonCommon(
