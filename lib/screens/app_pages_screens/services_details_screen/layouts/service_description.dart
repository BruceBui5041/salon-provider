  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        Expanded(
          child: DescriptionLayoutCommon(
              icon: eSvgAssets.clock, title: appFonts.duration, subtitle: "45 minute")
        ),
        Container(
            height: Sizes.s78,
            width: 1,
      ...
      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        Expanded(
          child: DescriptionLayoutCommon(
              icon: eSvgAssets.commission, title: appFonts.commission, subtitle: "30%")
        ),
        Container(
            height: Sizes.s78,
            width: 1,
      ...
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        const VSpace(Sizes.s20),
         ServiceAreaLayout(onTapAdd: ()=> route.pushNamed(context, routeName.locationList)),
        const VSpace(Sizes.s15),
        Text("\u2022 Foamjet tachnology removes dust 2x deeper.",style: appCss.dmDenseMedium13.textColor(appColor(context).appTheme.lightText))
      ]).paddingSymmetric(horizontal: Insets.i20).paddingSymmetric( vertical: Insets.i20)
