...
class _ServicesDetailsScreenState extends State<ServicesDetailsScreen> with TickerProviderStateMixin {
  @override
  Widget build(BuildContext context) {
    return Consumer2<ServiceDetailsProvider,LocationProvider>(builder: (context, value,val, child) {
      return Scaffold(
          body: SingleChildScrollView(
              child: Column(children: [
        ServiceImageLayout(
          editTap: ()=> route.pushNamed(context, routeName.addNewService,arg: {
            "isEdit": true,
