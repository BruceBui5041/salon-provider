          ...
          return Container(
                ...
                child: Column(children: [
                  ...
                  Expanded(
                      child: ListView.builder(
                        shrinkWrap: true,
                          ...
                          itemCount: appArray.currencyList.length,
                          itemBuilder: (context1, index) {
                            return BulletLayout(
                                currency: currencys,
                                data: appArray.currencyList[index],
                                index: index,
                  ...
                  Row(children: [
                    ...
                    Expanded(child: ButtonCommon(title: appFonts.update,onTap: ()=> value.onUpdate(context,appArray.currencyList[value.selectIndex])))
