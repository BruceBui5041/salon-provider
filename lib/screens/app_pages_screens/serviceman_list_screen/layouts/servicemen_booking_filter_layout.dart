...
class ServicemenBookingFilterLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<ServicemanListProvider>(builder: (context, value, child) {
      return Column(
                          ...
                          Expanded(
                            ...
                            Expanded(
                                    ...
                                    child: Column(
                                      ...
                                      SingleChildScrollView(
                                          child: Container(
                                              ...
                                              left: Insets.i20,
                                              right: Insets.i20)),
                                      Text(language(context, value.selectIndex == 0 ? appFonts.categoryList :  appFonts.showMemberSince),
                              ...
                              value.selectIndex == 0 ?
                                  Column(
                                    children: [
                                      SearchTextFieldCommon(controller: value.categoryCtrl,focusNode: value.categoryFocus,)
                                          .padding(bottom: Insets.i15, horizontal: Insets.i20),
                                      ...appArray.filterCategoriesList
                                          .asMap()
                                          .entries
                                          ...
                                          index: e.key,
                                          onTap: () => value.onCategoryChange(context, e.key)))
                                          .toList()
                                    ]
                                  )
                                  :  Column(
                           ...
                           /* Expanded(child: Column(
                            ...
                            BottomSheetButtonCommon(
                                ...
                                applyTap: () {},
                                clearTap: () {}).padding(horizontal: Insets.i20,bottom: Insets.i10)
                          ]))
