          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  children: [
                    ...
                    if(data!.packageId != null)
                      ButtonCommon(
                          ...
                          borderColor: appColor(context).appTheme.online,
            ...
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              IntrinsicHeight(
                  child: Row(
                      ...
                      children: [
                        ...
                        Expanded(
                            child: Text(language(context, data!.location!),
              ...
              if (data!.status != "Pending" && data!.status != "Completed" &&
                ...
                context, bColor: appColor(context).appTheme.stroke),
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        text: TextSpan(
                            style: appCss.dmDenseMedium12.textColor(
                                data!.status == "Assigned" || data!.status ==
                                    language(context, appFonts.ongoing) ||
                                    data!.status == "Cancelled" || (data!.status == "Accepted" && data!.assignMe != "Yes")
