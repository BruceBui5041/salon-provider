        ...
        Container(
            ...
            decoration: BoxDecoration(
                ...
                borderRadius: rtl(context) ? BorderRadius.only(
                    ...
                    bottomRight:
                    Radius.circular(isSentByMe == true ?  Insets.i20 : 0),
                    bottomLeft:
                    Radius.circular(isSentByMe == true ? 0 : Insets.i20)) :
                BorderRadius.only(
                    topRight: const Radius.circular(Insets.i20),
                    topLeft: const Radius.circular(Insets.i20),
                    bottomRight:
            ...
            child: Column(
              ...
              Row(children: [
                if (isSentByMe == true) SvgPicture.asset(eSvgAssets.doubleTick).paddingOnly(right: Insets.i5),
                Text(now,
                    style: appCss.dmDenseRegular12.textColor(isSentByMe == true
                        ? appColor(context).appTheme.whiteColor
