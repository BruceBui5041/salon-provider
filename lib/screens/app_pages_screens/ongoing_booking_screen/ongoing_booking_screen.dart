...
class OngoingBookingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer2<OngoingBookingProvider,AddExtraChargesProvider>(builder: (context, value,addValue, child) {
      ...
      return StatefulWrapper(
          ...
          child: Scaffold(
              ...
              body: Stack(alignment: Alignment.bottomCenter, children: [
                SingleChildScrollView(
                  ...
                  Column(
                      ...
                      children: [
                        ...
                        if(addValue.chargeTitleCtrl.text != "" && addValue.perServiceAmountCtrl.text != "")
                ...
                Material(
                    elevation: 20,
                    child: value.isServicemen ?  AssignStatusLayout(
                      status: appFonts.status,
                        title: appFonts.serviceInProgress, isGreen: true) : Row(children: [
                      Expanded(
                          child: ButtonCommon(
                            onTap: ()=> route.pushNamed(context, routeName.completedBooking),
