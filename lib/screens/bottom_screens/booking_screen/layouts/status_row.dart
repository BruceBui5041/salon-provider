...
class StatusRow extends StatelessWidget {
  ...
  const StatusRow({super.key, this.title,this.style,this.title2,this.statusText});
  ...
  Widget build(BuildContext context) {
    return Row(
        ...
        children: [
          ...
          BookingStatusLayout(title: statusText,color: colorCondition(statusText,context)) :
