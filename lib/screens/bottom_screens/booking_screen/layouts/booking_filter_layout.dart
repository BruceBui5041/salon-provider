          ...
          Expanded(
              child: Column(children: [
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                        children: [
                          ...
                          SearchTextFieldCommon(focusNode: value.categoriesFocus,controller: value.categoryCtrl)
                          ...
                          calendarStyle: CalendarStyle(
                              ...
                              todayDecoration: BoxDecoration(
                                  color: appColor(context)
                                      ...
                                      .primary
                                      .withOpacity(.10),
                                  shape: BoxShape.circle))).paddingSymmetric(vertical:
                ...
                BottomSheetButtonCommon(textOne: appFonts.clearAll,
                    ...
                    clearTap: ()=> route.pop(context)).paddingSymmetric(
