...
class LoginLayout extends StatelessWidget {
  ...
  const LoginLayout({super.key,this.isProvider = false,this.onForget,this.recognizer});

  @override
  Widget build(BuildContext context) {
    return Consumer2<LoginAsProvider,LoginAsServicemanProvider>(builder: (context1, value,value2, child) {
        ...
        Column(
            ...
            children: [
              ...
              TextFieldCommon(
                      ...
                      controller: isProvider == true ? value.passwordController : value2.passwordController,
                      hintText: language(context, appFonts.enterPassword),
                      focusNode: isProvider == true ? value.passwordFocus : value2.passwordFocus,
              ...
              ButtonCommon(
                      ...
                      onTap: ()=> route.pushNamed(context, routeName.dashboard))
                  .paddingSymmetric(horizontal: Insets.i20),
             if(isProvider == true)
              RichText(
                  text: TextSpan(
