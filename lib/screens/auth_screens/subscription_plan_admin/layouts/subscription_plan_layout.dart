  ...
  Widget build(BuildContext context) {
    return  Container(
        ...
        decoration: BoxDecoration(
            image: DecorationImage(image: AssetImage(eImageAssets.subPlanBg),fit: BoxFit.fill)),
        child: SingleChildScrollView(
          child: data != null ?  Column(
              children: [
               ...
               ...data!.benefits!.map((e) => PlanRowCommon(title: e,index: null,selectIndex: null)),
                Stack(
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child:SlideTransition(
                            ...
                            .inkWell(onTap: (){}).paddingSymmetric(horizontal: Insets.i15)
                      ]
                ...
                ButtonCommon(
                    ...
                    title: appFonts.startYourFreeTrial,color: appColor(context).appTheme.red).paddingOnly(bottom: Insets.i10)
              ]
          ).padding(top: Insets.i60,horizontal: Insets.i25) : Container()
        )
    );
  }
}
