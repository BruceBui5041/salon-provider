import 'package:fixit_provider/helper/app_icon_class.dart';
        ...
        Stack(
          children: [
            MultiSelectDropDownCustom(
                    ...
                    options: <ValueItem>[
                      ValueItem(
                          label: language(context, appFonts.english),
                          value: '1'),
                      ValueItem(
                          label: language(context, appFonts.german),
                          value: '2'),
                      ValueItem(
                          label: language(context, appFonts.spanish),
                          value: '3'),
                      ValueItem(
                ...
                .paddingSymmetric(horizontal: Insets.i20),
            SvgPicture.asset(eSvgAssets.country, colorFilter: ColorFilter.mode(value.languageSelect != "[]" ? appColor(context).appTheme.darkText : appColor(context).appTheme.lightText, BlendMode.srcIn),).paddingOnly(
        ...
        DottedBorder(
                ...
                child: ClipRRect(
                    ...
                    child: Container(
                        ...
                        ).paddingSymmetric(vertical: Insets.i15)))).inkWell(onTap: ()=> value.onImagePick(context))
            .paddingSymmetric(horizontal: Insets.i20),
