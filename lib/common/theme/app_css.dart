...
//Text Style dmDense extra bold
  ...
  TextStyle dmDenseSemiBold17 =
      dmDense(fontWeight: semiBold, fontsize: FontSizes.f17);
  ...
  TextStyle dmDenseSemiBold6 =
      dmDense(fontWeight: semiBold, fontsize: FontSizes.f6);

  //Text Style dmDense medium
  TextStyle dmDenseMedium44 =
      dmDense(fontWeight: medium, fontsize: FontSizes.f44);
