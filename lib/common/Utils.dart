...
class Utils {
  ...
  static double calculateTravelFeeAmount(Booking? booking) {
  ...
  // Get travel fee display value for booking layouts
  static String getTravelFeeDisplayValue(
      Booking? booking, BuildContext context) {
    if (booking?.fees != null && booking!.fees!.isNotEmpty) {
      final travelFee = booking.fees!.firstWhere(
        (fee) => fee.type == FeeType.travelFeePerKm,
        orElse: () => Fee(
